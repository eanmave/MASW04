...
if ($sendData && isset($_POST['givenName']) && isset($_POST['surNames']) && isset($_POST['birthDate']) && isset($_POST['country'])) {
    $error = storeDirector($_POST['givenName'], $_POST['surNames'], $_POST['birthDate'], $_POST['country']);
}
        ...
        ?>
            <div class="row">
                <div class="alert alert-danger" role="alert">
                    El director no se ha creado correctamente. <br><br><?php echo $error; ?><br><br><a href="create.php">Volver a
                        intentarlo</a>
                </div>
            </div>
        <?php
